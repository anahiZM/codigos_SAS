...
model y(event='1')= color spine width weight color*spine color*width color*weight  
spine*width spine*weight width*weight / selection=backward lackfit;
run;

proc hpgenselect data=crabs;
class color spine;
